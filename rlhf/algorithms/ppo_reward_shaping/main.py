...
from rlhf.algorithms.ppo_reward_shaping.trainer import PPORewardShapingTrainer
from rlhf.configs import get_deepspeed_eval_config, get_deepspeed_train_config
from rlhf.datasets import parse_dataset
from rlhf.logger import set_logger_level
from rlhf.utils import seed_everything, str2bool


def parse_arguments() -> argparse.Namespace:
    """Parse the command-line arguments."""
    parser = argparse.ArgumentParser(
        prog='deepspeed --module rlhf.algorithms.ppo_lag',
