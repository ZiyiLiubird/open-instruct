...
nohup deepspeed  open_instruct/finetune_trainer.py \
    ...
    --save_total_limit 3 \
    --num_train_epochs 3 \
    --output_dir output/hf_train/llama_metamath_10k \
    --bf16 \
    --tf32 True \
    --torch_dtype bfloat16 \
    --overwrite_output_dir \
    --cache_dir /paratera5-data/private/liuziyi/cache/llama_metamath_10k \
    --report_to "tensorboard" &> hf_llama_metamath_10k.out &
    # --overwrite_output_dir \
    # --overwrite_cache \
